package com.jiuxiang.didilogistics.alipay;
...
import com.jiuxiang.didilogistics.alipay.util.OrderInfoUtil2_0;
...
//                        showAlert(PayDemoActivity.this, getString(R.string.pay_success) + payResult);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView moneyView = findViewById(R.id.pay_amount);
        moneyView.setText("￥" + String.valueOf(money) + "元");
        TextView descriptionView = findViewById(R.id.alipay_description);
...
//        String price = price;
        ...
        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(APPID, rsa2, PayDemoActivity.money, description + "[订单号：" + orderID + "]");
